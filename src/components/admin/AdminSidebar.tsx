...
const menuItems = [
  ...
  { label: 'Journals', href: '/admin/journals', icon: 'book' },
  { label: 'Articles', href: '/admin/articles', icon: 'document' },
  ...
  { label: 'Media Library', href: '/admin/media', icon: 'photo' },
];
    ...
    <aside className="w-64 bg-[#1e3a5f] min-h-screen flex flex-col">
      ...
      <div className="p-6 border-b border-white/10">
        <Link href="/admin" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white font-bold text-lg">CMS Admin</h1>
            <p className="text-white/50 text-xs">Content Management</p>
          </div>
        </Link>
      </div>
