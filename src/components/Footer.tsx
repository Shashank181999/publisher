          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`mailto:${companyInfo.contact.email}`} className="text-white/70 hover:text-white transition">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              <Link href="/privacy" className="text-white/50 hover:text-white transition">Privacy Policy</Link>
              <Link href="/terms" className="text-white/50 hover:text-white transition">Terms of Use</Link>
              <Link href="/author-guidelines" className="text-white/50 hover:text-white transition">Author Guidelines</Link>
              <Link href="/ethics" className="text-white/50 hover:text-white transition">Publication Ethics</Link>
            </div>
          </div>
        </div>
      </div>
